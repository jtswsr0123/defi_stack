...
contract TokenFarm is Ownable {
    ...
    // mapping token address with its price feed address
    ...
    // for the given user address, compute the total value of staked tokens
    ...
    // using chainlink to sum up the total token values converted into usd
    ...
    // transfer the token from user to token farm, update staker list if needed
